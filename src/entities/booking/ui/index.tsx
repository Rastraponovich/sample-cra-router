    ...
    return (
        ...
        >
            ...
            <div className={clsx("z-10 flex items-start justify-between", compact && "order-2 space-x-2 ")}>
                <div className={clsx(compact ? "flex items-center space-x-2" : "flex flex-col space-y-1", "text-sm")}>
                    <span className=" truncate drop-shadow-xl ">
                        c {daysJS(Number(reserve.startDate)).format("DD.MM.YYYY HH:mm")}
                    </span>
                    <span className=" truncate drop-shadow-xl ">
                        по {daysJS(Number(reserve.endDate)).format("DD.MM.YYYY HH:mm")}
                    </span>
                </div>
                <span
                    className={clsx(
