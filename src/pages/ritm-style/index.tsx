...
export const RitmStypePage = () => {
    return (
        <main className="grow bg-[#162831] px-10">
                ...
                <nav className="text-sm font-normal leading-[19px]">
                    <ul className="flex items-center space-x-[50px]">
                        <li className="first-letter:uppercase">
                            <NavLink to="/ritm-style">
                                <a className="duration-150 hover:underline hover:underline-offset-2">главная</a>
                            </NavLink>
                        </li>
                        <li className="first-letter:uppercase">
                            <NavLink to="/ritm-style">
                                <a className="duration-150 hover:underline hover:underline-offset-2">сеансы</a>
                            </NavLink>
                        </li>
                        <li className="first-letter:uppercase">
                            <NavLink to="/ritm-style">
                                <a className="duration-150 hover:underline hover:underline-offset-2">отзывы</a>
                            </NavLink>
                        </li>
                        <li className="first-letter:uppercase">
                            <NavLink to="/ritm-style">
                                <a className="duration-150 hover:underline hover:underline-offset-2">контакты</a>
                            </NavLink>
                        </li>
                        <li className="first-letter:uppercase">
                            <NavLink to="/ritm-style">
                                <a className="duration-150 hover:underline hover:underline-offset-2">новости</a>
                            </NavLink>
                        </li>
                        <li className="first-letter:uppercase">
                            <NavLink to="/ritm-style">
                                <a className="duration-150 hover:underline hover:underline-offset-2">обо мне</a>
                            </NavLink>
                        </li>
                        <li className="first-letter:uppercase">
                            <NavLink to="/ritm-style">
                                <a className="duration-150 hover:underline hover:underline-offset-2">блог</a>
                            </NavLink>
                        </li>
                    </ul>
                </nav>
            ...
            <main className="flex flex-col pt-5">
                ...
                <section className="flex flex-col items-center pt-[150px] font-ElMessiri text-white">
                    <div className="mb-[100px] flex items-center">
                        ...
                        <h3 className=" mx-[45px] text-[42px] font-bold leading-[60px]">Сеансы RitmStyle</h3>
                        <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M28 0H14C6.26801 0 0 6.26801 0 14H14C21.732 14 28 7.73199 28 0Z" fill="#018ABE" />
                        </svg>
                    </div>

                    <div className="grid grid-cols-3 gap-6 text-2xl font-bold leading-[33,6]">
                        <div className="relative col-span-1 row-span-2 flex   w-[416px]  items-end rounded-[10px] bg-[#018ABE80]/50 bg-[url('/public/assets/ritmstyle/seans-2xl.png')] bg-cover  px-10 pb-[30px]">
                            <span>Стандартный RitmStyle</span>
                        </div>
                        <div
                            style={{
                                background:
                                    " linear-gradient(0deg, rgba(1, 138, 190, 0.5), rgba(1, 138, 190, 0.5)), url(/assets/ritmstyle/figure.jpg), #8E8E8E",
                                backgroundSize: "cover",
                            }}
                            className="col-span-1 flex h-[258px] w-[416px] items-end rounded-[10px]   px-10 pb-[30px] "
                        >
                            <span>RitmStyle для пар</span>
                        </div>
                        <div className="col-span-1 flex h-[258px] w-[416px] items-end rounded-[10px] bg-[#018ABE80]/50 bg-[url('/public/assets/ritmstyle/seans.png')] bg-cover px-10 pb-[30px]">
                ...
                <section className="flex flex-col items-center pt-[150px] font-ElMessiri text-white">
                    ...
                    <div className="mb-[60px] grid grid-cols-3 place-items-center gap-x-[50px] font-sans">
                        <article className="cursor pointer group rounded-[10px] bg-[#018ABE] px-[45px] pt-10 pb-[56px] opacity-40 duration-150 hover:px-[60px] hover:pt-[50px] hover:opacity-100">
                            <h2 className="group:hover:mb-5 mb-[15px] text-base font-bold duration-150 group-hover:text-xl">
                                Александра Дмитриева
                            </h2>
                            <p className="mb-3.5 text-[10px] font-light duration-150 group-hover:text-sm">
                            ...
                            <p className=" text-[10px] font-light duration-150 group-hover:text-sm">
                ...
                <section className="flex flex-col items-center space-y-[100px] px-[422px] pt-[150px] font-ElMessiri text-white">
                    ...
                    <figure className="flex space-x-[84px]">
                        <img src="/assets/ritmstyle/figure.jpg" alt="" height={526} width={325} />
                        <figcaption className="flex flex-col space-y-[30px]">
                            <h4 className="text-2xl font-bold">RitmStyle массаж </h4>
                ...
                <section className="flex flex-col items-center space-y-[100px] px-[422px] pt-[150px] font-ElMessiri text-white">
                    ...
                    <article className="flex space-x-[134px]">
                        <ul className="flex w-full max-w-[416px] flex-col items-start justify-center space-y-[30px] text-lg font-normal leading-[25px]">
                            <li className="flex w-full items-center justify-between">
                                ...
                                <span className="grow px-5 first-letter:uppercase">RitmStyle с погружением</span>
                                <span className="font-bold after:content-['р.']">1000</span>
                            </li>
                            <li className="flex w-full items-center justify-between">
                                <svg
                                    width="18"
                                ...
                                <span className="grow px-5  first-letter:uppercase">абонемент на RitmStyle</span>
                                <span className="font-bold after:content-['р.']">5500</span>
                            </li>
                            <li className="flex w-full items-center justify-between">
                                <svg
                                    width="18"
                                ...
                                <span className="grow px-5  first-letter:uppercase">ritmStyle для пар</span>
                                <span className="font-bold after:content-['р.']">6000</span>
                            </li>
                            <li className="flex w-full items-center justify-between">
                                <svg
                                    width="18"
                                ...
                                <span className="grow px-5  first-letter:uppercase">ritmStyle для беременных</span>
                                <span className="font-bold after:content-['р.']">13500</span>
                            </li>
                            ...
                            <li className="flex w-full items-center justify-between">
                                ...
                                <span className="grow px-5  first-letter:uppercase">ritmStyle + фотосессия</span>
                                <span className="font-bold after:content-['р.']">11500</span>
                            </li>
                        </ul>
                        <figure className="flex  w-[526px] flex-col space-y-[30px]">
                            <img src="/assets/ritmstyle/card.jpg" alt="" height={396} width={526} />
                            <figcaption className="flex flex-col space-y-[30px] text-center">
                                <span className="text-2xl font-bold">RitmStyle массаж </span>
                            </figcaption>
                        </figure>
                    </article>
                </section>
            </main>
            <aside className="grid grid-cols-3 items-stretch gap-12 rounded-[10px] px-[312px] pt-[150px] pb-[60px]">
                <img
                ...
                <div className="flex flex-col  rounded-[10px] bg-[#018ABE] py-[35px] px-[45px] text-white">
                    <h4 className="font-ElMessiri text-2xl font-bold leading-[36px] first-letter:uppercase">
                        бассейн WorkClass
                    </h4>
                    <ul className="mt-[21px] mb-[30px] flex flex-col space-y-[21px]">
                        <li className="ml-5 text-sm font-normal leading-[18px]">Невский 140</li>
                        <li className="ml-5 text-sm font-normal leading-[18px]">м. Спасская</li>
                        <li className="ml-5 text-sm font-normal leading-[18px]">Запись по договоренности</li>
                    </ul>
                ...
                <div className="flex flex-col space-y-[21px] rounded-[10px] bg-[#018ABE] py-[35px] px-[45px] text-white">
                    ...
                    <ul className="mt-[21px] mb-[30px] flex flex-col space-y-[21px]">
                        <li className="ml-5 text-sm font-normal leading-[18px]">3-й проезд Иванова</li>
                        <li className="ml-5 text-sm font-normal leading-[18px]">м. Крестовский остров</li>
                        <li className="ml-5 text-sm font-normal leading-[18px]">Запись по договоренности</li>
                    </ul>
                    <button className="self-start rounded-[3px] bg-white px-[15px] py-[9px] text-[13px] font-semibold leading-[18px] text-[#018ABE] duration-150 first-letter:uppercase hover:scale-110">
                        записаться на сеанс
            ...
            <footer className="flex items-center justify-between py-[30px] px-[312px] text-base font-normal leading-[18px] text-white">
