...
const __routes__: TRoute[] = [
    { id: 1, text: "главная", path: "/ritm-style" },
    { id: 2, text: "сеансы", path: "#seances" },
    { id: 3, text: "отзывы", path: "#reviews" },
    { id: 4, text: "контакты", path: "#contacts" },
    { id: 5, text: "новости", path: "/ritm-style" },
    { id: 6, text: "обо мне", path: "/ritm-style" },
    { id: 7, text: "блог", path: "/ritm-style" },
]
    ...
    return (
        <main className="grow bg-[#162831] px-10 md:px-[100px] xl:px-[200px]  2xl:px-[312px]">
            <header className="flex items-center justify-between  py-[30px] font-sans text-white">
                ...
                <nav className="hidden text-sm font-normal leading-[19px] lg:block">
                    <ul className="flex items-center space-x-6 2xl:space-x-[50px]">
                        {__routes__.map((route) => (
                            <li className="first-letter:uppercase" key={route.id}>
                                <NavLink
                                    to={route.path}
                                    className="duration-150 hover:underline hover:underline-offset-2"
                                >
                                    {route.text}
                                </NavLink>
                            </li>
            ...
            <main className="flex flex-col pt-5">
                ...
                <section
                    id="seances"
                    className="flex flex-col items-center py-16 font-ElMessiri text-white 2xl:py-[75px]"
                >
                    <div className="mb-12 flex items-center 2xl:mb-[100px]">
                        <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0H14C21.732 0 28 6.26801 28 14H14C6.26801 14 0 7.73199 0 0Z" fill="#018ABE" />
                        </svg>
                        <h3 className="mx-[45px] text-center text-[42px] font-bold leading-[60px]">Сеансы RitmStyle</h3>
                        <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <section
                    id="reviews"
                    className="flex flex-col items-center py-16 font-ElMessiri text-white 2xl:-mx-[220px] 2xl:py-[75px]"
                >
                    <div className="mb-12 flex items-center 2xl:mb-[100px]">
                        <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0H14C21.732 0 28 6.26801 28 14H14C6.26801 14 0 7.73199 0 0Z" fill="#018ABE" />
                    ...
                    <div className="mb-[60px] grid grid-cols-1 place-items-center gap-y-8 font-sans lg:grid-cols-3 lg:gap-y-0 lg:gap-x-[50px]">
                ...
                <section className="flex flex-col items-center   py-16 font-ElMessiri text-white 2xl:py-[75px] 2xl:px-[110px]">
                    <div className="mb-12 flex items-center 2xl:mb-[100px]">
                        <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0H14C21.732 0 28 6.26801 28 14H14C6.26801 14 0 7.73199 0 0Z" fill="#018ABE" />
                        </svg>
                        <h3 className="mx-[45px] text-center text-[42px] font-bold leading-[60px] first-letter:uppercase">
                            об RitmStyle
                        </h3>
                        <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M28 0H14C6.26801 0 0 6.26801 0 14H14C21.732 14 28 7.73199 28 0Z" fill="#018ABE" />
                    ...
                    <figure className="mb-12  flex flex-col items-center space-y-11 md:flex-row md:space-y-0 md:space-x-[84px] 2xl:mb-[100px]">
                        <img
                        ...
                        />
                        <figcaption className="flex flex-col space-y-4 2xl:space-y-[30px]">
                            <h4 className="text-base font-bold 2xl:text-2xl">RitmStyle массаж </h4>
                            <p className="text-sm font-light 2xl:text-base">
                    ...
                    <figure className="mb-12 flex  flex-col items-center space-y-11  md:flex-row-reverse md:space-y-0 md:space-x-[84px] md:space-x-reverse 2xl:mb-[100px]">
                        <img
                            src="/assets/ritmstyle/figure.jpg"
                            alt="service"
                            height={526}
                        ...
                        />
                        <figcaption className="flex flex-col space-y-4 2xl:space-y-[30px]">
                            <h4 className="text-base font-bold 2xl:text-2xl">RitmStyle гидротерапия</h4>
                            <p className="text-sm font-light 2xl:text-base">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec in purus, sed tellus eget
                                mattis nibh quam. Eu ornare nunc, id est. Erat consectetur etiam a sit diam in imperdiet
                                amet. Diam nisl, ipsum suscipit amet. Eleifend amet habitasse proin quis adipiscing.
                ...
                <section className="flex flex-col items-center space-y-12 py-16 font-ElMessiri text-white 2xl:space-y-[100px] 2xl:py-[75px] 2xl:px-[110px]">
                    ...
                    <article className="flex w-full flex-col justify-between md:flex-row md:space-x-[64px] lg:space-x-[134px]">
                        ...
                        <figure className="hidden max-w-[216px]  flex-col space-y-[30px] md:flex  2xl:w-[526px]">
                            <img
            ...
            <aside
                id="contacts"
                className="grid grid-cols-2 items-stretch gap-12 rounded-[10px] px-0 py-[75px] lg:px-[110px] 2xl:grid-cols-3"
            >
                <img
            ...
            <footer className="flex items-center justify-between py-[30px] px-0 text-base font-normal leading-[18px] text-white lg:px-[110px]">
...
const ContactCard = memo(({ contact }: ContactCardProps) => {
    return (
        <div className="col-span-2 flex flex-col space-y-[21px] rounded-[10px] bg-[#018ABE] py-[35px] px-6 text-white md:col-span-1 2xl:px-[45px] ">
...
const ReviewCard = memo(({ review, selected, onClick }: ReviewCardProps) => {
    return (
        ...
        >
            <h2 className={clsx("mb-[15px] text-base font-bold duration-150", selected && "mb-5 text-xl")}>
                {review.name}
            </h2>
            <p
                className={clsx(
