            ...
            <header className="flex items-center justify-between py-[30px] font-sans text-white">
                ...
                <nav className="text-sm font-normal leading-[19px]">
                    <ul className="flex items-center space-x-[50px]">
                        <li className="first-letter:uppercase">главная</li>
                        <li className="first-letter:uppercase">сеансы</li>
                        <li className="first-letter:uppercase">отзывы</li>
                        <li className="first-letter:uppercase">контакты</li>
                        <li className="first-letter:uppercase">новости</li>
                        <li className="first-letter:uppercase">обо мне</li>
                        <li className="first-letter:uppercase">блог</li>
                    </ul>
                </nav>
                <button className="rounded-[3px] bg-[#018ABE] py-[9px] px-[15px] text-[13px] font-semibold leading-[18px] first-letter:uppercase">
                    записатся на сеанс
                </button>
            </header>
            <main className="flex flex-col pt-5">
                ...
                <section className="flex flex-col items-center pt-[150px] font-ElMessiri text-white">
                    ...
                    <div className="mb-[60px] grid grid-cols-3 place-items-center gap-x-[50px] font-sans">
                        <article className="rounded-[10px] bg-[#018ABE] px-[45px] pt-10 pb-[56px] opacity-40">
                            <h2 className="mb-[15px] text-base font-bold">
                                Александра Дмитриева
                            </h2>
                            <p className="mb-3.5 text-[10px] font-light">
                                Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit. Netus diam risus morbi nulla
                                dictum. Urna mi orci gravida placerat amet, eu,
                                aliquet facilisis aliquet. Dolor praesent nam
                                ornare fringilla enim nibh donec sit imperdiet.
                                Amet, diam duis eu sit et. Volutpat vestibulum a
                                lectus sed blandit.
                            </p>
                            <p className=" text-[10px] font-light">
                                Venenatis urna mattis eu enim molestie iaculis
                                et aliquet. Velit in pellentesque vestibulum
                                phasellus orci. Fermentum sed phasellus aliquam
                                nulla non aenean. Quisque id nunc, mauris
                                potenti a massa. Fermentum at elit, convallis
                                leo dolor aliquet id elementum. Ullamcorper
                                sociis et cum bibendum in egestas. Diam, urna,
                                sed tempus mollis aliquam elit. Facilisi nam
                                nulla pulvinar mauris vel lacinia venenatis.
                            </p>
                        </article>
                        <article className="rounded-[10px] bg-[#018ABE] px-[60px] pt-[50px] pb-[56px]">
                            <h2 className="mb-5 text-xl font-bold">
                                Кира Иванова
                            </h2>
                            <p className="mb-3.5 text-sm font-light">
                                Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit. Netus diam risus morbi nulla
                                dictum. Urna mi orci gravida placerat amet, eu,
                                aliquet facilisis aliquet. Dolor praesent nam
                    ...
                    <div className="flex items-center justify-center space-x-5">
                        <button className="h-4 w-4 rounded-[3px] bg-white"></button>
                        <button className="h-4 w-4 rounded-[3px] bg-white/40"></button>
                        <button className="h-4 w-4 rounded-[3px] bg-white/40"></button>
                        <button className="h-4 w-4 rounded-[3px] bg-white/40"></button>
                    </div>
                </section>
